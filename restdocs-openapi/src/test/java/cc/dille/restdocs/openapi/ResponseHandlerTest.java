...
public class ResponseHandlerTest {
    ...
    private void whenModelGenerated() {
        model = responseHandler.generateModel(operation, OpenAPIResourceSnippetParameters.builder().build());
    }
    private void whenModelGeneratedWithFieldDescriptors(FieldDescriptor... fieldDescriptors) {
        model = responseHandler.generateModel(operation, OpenAPIResourceSnippetParameters.builder()
