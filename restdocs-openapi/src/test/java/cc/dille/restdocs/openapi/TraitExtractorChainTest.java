...
public class TraitExtractorChainTest {
    ...
    private void whenModelGeneratedForPrivateResource() {
        model = traitExtractorChain.generateModel(new OperationBuilder().build(), OpenAPIResourceSnippetParameters.builder()
                .privateResource(true)
                .build());
    }

    private void whenModelGenerated() {
        model = traitExtractorChain.generateModel(new OperationBuilder().build(), OpenAPIResourceSnippetParameters.builder().build());
    }
