 ...
 * It it a wrapper and replacement for MockMvcRestDocumentation that transparently adds a OpenAPIResourceSnippet with the descriptors provided in the given snippets.
 */
public class OpenAPIDocumentation {
    ...
    protected static Snippet[] enhanceSnippetsWithopenAPI(String description,
        ...
        List<Snippet> openAPISnippets = new ArrayList<>();
        ...
        for (Snippet snippet : snippets) {
            ...
            } else if (snippet instanceof OpenAPIResourceSnippet) {
                openAPISnippets.add(snippet);
            } else {
        ...
        if (openAPISnippets.isEmpty()) { // No OpenAPIResourceSnippet, so we configure our own based on the info of the other snippets
            OpenAPIResourceSnippetParameters openAPIParameters = OpenAPIResourceSnippetParameters.builder()
                    ...
                    .build();
            enhancedSnippets.add(OpenAPIResourceDocumentation.openAPIResource(openAPIParameters));
        } else {
            enhancedSnippets.addAll(openAPISnippets);
        }
